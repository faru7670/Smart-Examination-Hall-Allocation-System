        ...
        <>
            <div className="p-6 border-b border-dark-700/50">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-lg font-bold text-slate-900">ExamHall</h1>
                    ...
                    <NavLink
                        ...
                        className={({ isActive }) =>
                            `flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 ${isActive
                                ...
                                : 'text-dark-400 hover:text-slate-900 hover:bg-dark-700/50'
                            }`
                        }
                    >
            ...
            <div className="p-4 border-t border-dark-700/50">
                <div className="glass-card p-4 mb-3">
                    <div className="flex items-center gap-3">
                        <div className={`w-9 h-9 rounded-lg bg-gradient-to-br ${roleColors[user?.role] || roleColors.admin} flex items-center justify-center text-slate-900 font-bold text-sm`}>
        ...
        <div className="flex h-screen overflow-hidden bg-dark-950">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                <header className="lg:hidden flex items-center gap-4 px-4 py-3 bg-dark-900/50 backdrop-blur-xl border-b border-dark-700/50">
                    <button onClick={() => setSidebarOpen(true)} className="p-2 text-dark-400 hover:text-slate-900">
