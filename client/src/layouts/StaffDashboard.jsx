        ...
        <div className={`min-h-screen ${theme === 'dark' ? 'bg-slate-50 text-slate-900' : 'bg-slate-50 text-slate-900'}`}>
            <header className="sticky top-0 z-50 glass border-b border-purple-500/20 shadow-sm">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between">
                        ...
                        {TABS.map(t => {
                            ...
                            return (
                                <button key={t.id} onClick={() => setTab(t.id)}
                                    ...
                                    ${active ? 'text-purple-500 bg-purple-500/10' : 'text-slate-600 hover:text-purple-400 hover:bg-slate-100'}`}>
                                    {t.label}
                    ...
                    <div className="flex items-center gap-5 py-4 pl-4 border-l border-slate-200 ml-2">
